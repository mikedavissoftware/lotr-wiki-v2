...
class WeaponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weapon" do
    assert_difference("Weapon.count") do
      post weapons_url, params: { weapon: { image_url: @weapon.image_url, movie_character_id: @weapon.movie_character_id, name: @weapon.name, type: @weapon.type } }
    end
  ...
  test "should update weapon" do
    patch weapon_url(@weapon), params: { weapon: { image_url: @weapon.image_url, movie_character_id: @weapon.movie_character_id, name: @weapon.name, type: @weapon.type } }
