...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference("Actor.count") do
      post actors_url, params: { actor: { movie_character_id: @actor.movie_character_id, name: @actor.name, wikipedia_url: @actor.wikipedia_url } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { movie_character_id: @actor.movie_character_id, name: @actor.name, wikipedia_url: @actor.wikipedia_url } }
